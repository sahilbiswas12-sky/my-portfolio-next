  ...
  return (
    <main className="min-h-screen bg-[#050505] px-6 py-24 text-white sm:px-8 lg:px-12">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-16 rounded-4xl border border-orange-400/10 bg-orange-400/3 p-8">
          <h2 className="text-2xl font-semibold">
            Project Overview
          </h2>

          <p className="mt-4 leading-8 text-white/50">
            This portfolio demonstrates modern frontend development,
            responsive design, reusable components, interactive
            interfaces, and professional presentation.
          </p>
        </div>
